              ...
              <template x-for="(empresa, index) in empresas" :key="index">
                <tr class="bg-white text-gray-600 border-b border-gray-200">
                  ...
                  <td class="px-4 py-3 text-sm">
                    <span class="rounded-xl text-sm text-green-700 bg-green-100 leading-tight font-semibold px-2 py-1"
                      x-show="empresa.estado == 1">Activo</span>
                    <span class="rounded-xl text-sm text-red-700 bg-red-100 leading-tight font-semibold px-2 py-1"
                      x-show="empresa.estado == 2">NoActivo</span>
                  </td>
                  <td class="text-center">
                    <!-- Option -->
                    <div class="relative inline-block text-left">
                      <div>
                        <a href="#" @click="empresa.open = !empresa.open"
                          class="rounded-full bg-gray-100 px-3 py-1 shadow-xs">
