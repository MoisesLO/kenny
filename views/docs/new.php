        ...
        <div class="w-full rounded-md shadow-xs">
          <div class="w-full mt-8">
            ...
            <div x-data="invoices()" x-init="generateInvoiceNumber(111111, 999999);" x-cloak>
              <div class="block bg-gray-100 rounded-tl-lg rounded-tr-lg px-5 py-1 text-bold text-gray-500">
                ...
                <div class="container mx-auto py-6">
                  <div class="flex mb-8 justify-between">
                    ...
                    <div class="w-2/4">
                      ...
                      <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <div class="flex-1">
                          <input class="bg-gray-100 appearance-none border-2 border-gray-100 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="eg. #INV-100001" x-model="factura.numero">
                        </div>
                      </div>
                      ...
                      <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <span class="mr-4 inline-block hidden md:block">:</span>
                        <div class="flex-1">
                          <input class="bg-gray-100 appearance-none border-2 border-gray-100 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="F001" x-model="factura.serie">
                        </div>
                      </div>
                      ...
                      <div class="mb-2 md:mb-1 md:flex items-center">
                        ...
                        <span class="mr-4 inline-block hidden md:block">:</span>
                        <div class="flex-1">
                          <input class="bg-gray-100 appearance-none border-2 border-gray-100 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 js-datepicker" id="datepicker" type="text" placeholder="eg. 17 Mar, 2020" x-model="factura.fecha" x-on:change="factura.fecha = document.getElementById('datepicker').value" autocomplete="off" readonly>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="flex flex-wrap justify-between mb-8">
                    ...
                    <div class="w-full md:w-1/3 mb-2 md:mb-0">
                      ...
                      <!-- Cliente Razon -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="Razon Social" x-model="factura.clienteRazon">

                      <!-- Cliente Documento -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="RUC" x-model="factura.clienteDocumento">

                      <!-- Cliente Direccion -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="Direcion" x-model="factura.clienteDireccion">
                    </div>
                    ...
                    <div class="w-full md:w-1/3">
                      ...
                      <!-- Empresa Razon -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="Your company name" x-model="factura.empresaRazon">

                      <!-- Empresa Documento -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="Your company address" x-model="factura.empresaDocumento">

                      <!-- Empresa Direccion -->
                      <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="Additional info" x-model="factura.empresaDireccion">
                    </div>
                  </div>
                  ...
                  <div class="py-10 text-right">
                    <a class="bg-gray-500 hover:bg-gray-700 text-white font-semibold py-2 px-4 border border-gray-700 rounded shadow-sm" @click="addInvoice()">Enviar Factura</a>
                  </div>
                  ...
                  <div id="js-print-template" x-ref="printTemplate" class="hidden">
                    <div class="mb-8 flex justify-between">
                      <div>
                        ...
                        <div class="mb-1 flex items-center">
                          <label class="w-32 text-gray-600 block font-bold text-xs uppercase tracking-wide">
                            Numero
                          </label>
                          <span class="mr-4 inline-block">:</span>
                          <div x-text="factura.numero"></div>
                        </div>
                    ...
                    <div class="flex justify-between mb-10">
                      ...
                      <div class="w-1/2">
                        ...
                        <div>
                          <div x-text="factura.clienteRazon"></div>
                          <div x-text="factura.clienteDocumento"></div>
                      ...
                      <div class="w-1/2">
                        ...
                        <div>
                          <div x-text="factura.empresaRazon"></div>
                          <div x-text="factura.empresaDocumento"></div>
                          <div x-text="factura.empresaDireccion"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-1 border-b py-2 items-start">
                      ...
                      <div class="px-1 w-20 text-right">
                        <p class="text-gray-600 uppercase tracking-wide text-xs font-bold">Unidad</p>
                      </div>

                      <div class="px-1 w-32 text-right">
                        <p class="text-gray-600 uppercase tracking-wide text-xs font-bold">Cantidad</p>
                      </div>

                      <div class="px-1 w-32 text-right">
                        <p class="leading-none">
                          <span class="block uppercase tracking-wide text-xs font-bold text-gray-600">Precio Unitario</span>
                          <span class="font-medium text-xs text-gray-500">(Incl. IGV)</span>
                        </p>
                      </div>
                    ...
                    <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
                      ...
                      <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                        ...
                        <div class="mb-4">
                          ...
                          <input class="mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" x-model="item.name">
                        </div>
                        ...
                        <div class="flex">
                          ...
                          <div class="mb-4 w-1/3 mr-2">
                            ...
                            <input class="text-right mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" placeholder="0" type="text" x-model="item.cantidad">
                          </div>
                          ...
                          <div class="mb-4 w-1/3 mr-2">
                            ...
                            <input class="text-right mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="0.00" x-model="item.precio_unitario_con_igv">
                          </div>

                          <!-- Total -->
                          <div class="mb-4 w-1/3">
                            <label class="text-gray-700 block mb-1 font-semibold text-sm text-right tracking-wide">Total</label>
                            <input class="text-right mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" placeholder="0.00" x-model="item.total = item.cantidad * item.precio_unitario_con_igv">
                          </div>
                        </div>
                        ...
                        <div class="flex">
                          ...
                          <div class="mb-4 w-40 mr-2">
                            <div class="relative">
                              ...
                              <select class="text-gray-700 block appearance-none w-full bg-gray-100 border-2 border-gray-100 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-blue-500" x-model="item.unidad">
                          ...
                          <div class="mb-4 w-32 mr-2">
                            <div class="relative">
                              ...
                              <select class="text-gray-700 block appearance-none w-full bg-gray-100 border-2 border-gray-100 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-blue-500" x-model="item.igv">
                        ...
                        <div class="mt-8 text-right">
                          <button type="button" class="bg-white hover:bg-gray-100 text-gray-700 font-semibold py-2 px-4 border border-gray-200 rounded shadow-sm mr-2" @click="openModal = !openModal">
                            Cancelar
                          </button>
                          <button type="button" class="bg-gray-700 hover:bg-gray-500 text-white font-semibold py-2 px-4 border border-gray-600 rounded shadow-sm" @click="addItem()">
                            Agregar Item
                          </button>
                        </div>
                      </div>
