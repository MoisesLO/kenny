                    ...
                    <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                      ...
                      <div class="flex">
                        ...
                        <div class="mb-4 w-1/3 mr-2">
                          ...
                          <input
                              class="text-right mb-1 bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                      ...
                      <div class="flex">
                        ...
                        <div class="mb-4 w-40 mr-2">
                          <div class="relative">
                            ...
                            <select
                                class="text-gray-700 block appearance-none w-full bg-gray-100 border-2 border-gray-100 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                                x-model="item.unidad">
                      ...
                      <div class="mt-8 text-right">
                        <button type="button"
                                class="bg-white hover:bg-gray-100 text-gray-700 font-semibold py-2 px-4 border border-gray-200 rounded shadow-sm mr-2"
                                @click="openModal = !openModal">
                          Cancelar
                        </button>
                        <button type="button"
                                class="bg-gray-700 hover:bg-gray-500 text-white font-semibold py-2 px-4 border border-gray-600 rounded shadow-sm"
                                @click="addItem()">
                          Agregar Item
                        </button>
                      </div>
