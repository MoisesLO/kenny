      ...
      <div class="mx-10 my-2">
        ...
        <div class="w-full rounded-lg shadow-xs">
          <div class="w-full mt-8">
            <!-- Centrall -->
            <div class="px-4 py-3 bg-white antialiased sans-serif min-h-screen" style="min-height: 900px">
              <div class="container mx-auto py-6" x-data="invoices()" x-init="generateInvoiceNumber(111111, 999999);" x-cloak>
                <div class="flex justify-between pt-6">
                  <h2 class="text-4xl text-green-700 font-semibold mb-6 pb-2">
                    Nueva Factura
                  </h2>
                  <div>
                ...
                <div class="flex mb-8 justify-between">
                  <div class="w-2/4">
                    <div class="mb-2 md:mb-1 md:flex items-center">
                      <label class="w-32 text-green-700 block font-semibold text-sm uppercase tracking-wide">
                        Invoicdasdqsa No.
                      </label>
                  ...
                  <div class="mb-8 flex justify-between">
                    <div>
                      ...
                      <div class="mb-1 flex items-center">
                        <label class="w-32 text-gray-600 block font-bold text-xs uppercase tracking-wide">Invoicee No.</label>
